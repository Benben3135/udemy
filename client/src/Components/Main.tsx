          ...
          <div className="max-w-[82rem] mx-auto h-fit ">
            ...
            >
              <div className="h-[13.5rem] w-[26rem] bg-white shadow-md p-6 flex flex-col items-start justify-start gap-3">
                <h1 className=" font-bold text-2xl leading-[1.7rem] tracking-normal">Welcome back, <br />{userName} </h1>
                <p>Expand your horizons with learning that’s worldwide. Save now through Feb 8.</p>
              </div>
            </div>
          </div>
        </div>
