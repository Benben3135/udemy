        ...
        <div className="items-center w-full mx-auto">
          ...
          <div className=" flex flex-row justify-center items-start h-fit mt-6 gap-8">
            ...
            <div className=" flex-[0.7] flex flex-col items-start justify-start">
              ...
              <div className=" w-full h-[3rem] mt-2 bg-Udemypurple-300 hover:bg-Udemypurple-400 cursor-pointer text-white font-bold flex flex-row items-center justify-center">
                Checkout
              </div>
              ...
              <div className=" flex flex-col items-start justify-start w-full h-fit border-dashed border border-gray-200 p-2">
                <h3 className=" text-[0.75rem]"><span className="text-[0.95rem] font-bold text-gray-500">ST12MT030524</span> is applied</h3>
              ...
              <div className=" flex flex-row items-center justify-center w-full h-fit border border-black mt-2">
                <input className=" flex-[5] h-full outline-none" />
                <button onClick={() => setError(true)} className=" bg-Udemypurple-300 flex-[1] h-full px-2 py-1 text-white font-bold">Apply</button>
              </div>
              {error && <h3 className="text-Udemyred-400 text-[0.72rem] mt-1">The coupon code entered is not valid for this course. Perhaps you used the wrong coupon code?</h3>}
            </div>
          </div>
        </div>
      </div>
