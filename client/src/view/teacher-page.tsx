...
const TeacherPage = () => {
    ...
    return (
        <div style={{ display: "flex", gap: "25px", maxWidth: "91.2rem", margin: "0 auto", width: "912px", marginTop: "4.8rem", }}>
            <div className='instructor-data' style={{ maxWidth: "70%" }} >
                ...
                <div style={{ maxWidth: "100%" }}>
                    {courses && courses.length > 0 ? <Courses type={courses} componentsTitle={`My courses (${NumberOfCourses})`} /> : ""}
                </div>
            </div>
            <div style={{ display: "flex", justifyContent: "flex-start", alignItems: "center", flexDirection: "column", gap: "20px", maxWidth: "200px", }}>
                <img src={teacher.photoURL} alt="" style={{ borderRadius: "100%", width: "200px", height: "200px" }} />
                <div className='instructor-profile--social-links' style={{ display: "flex", gap: "0.8rem", alignItems: "center", justifyContent: "center", padding: "15px", flexDirection: "column" }}>
                    <a href={teacher.facebook} style={{ minWidth: "200px", height: "48px", display: "flex", gap: "5px", justifyContent: "center", alignItems: "center", border: "1px solid black", padding: "0 1.2rem" }}>
		...
		c-2.762,0-5,2.238-5,5v50.844C76.703,162.867,78.941,165.106,81.703,165.106z"/>
                    ...
                    <a href={teacher.linkedin} style={{ minWidth: "200px", height: "48px", display: "flex", gap: "5px", justifyContent: "center", alignItems: "center", border: "1px solid black", padding: "0 1.2rem" }}>
		...
		c-30.254,0-48.284,20.38-56.202,40.08c-2.897,7.012-3.602,16.861-3.602,26.711v184.047H177.124L177.124,500.219z">
                    ...
                    <a href={teacher.twitter} style={{ minWidth: "200px", height: "48px", display: "flex", gap: "5px", justifyContent: "center", alignItems: "center", border: "1px solid black", padding: "0 1.2rem" }}>
